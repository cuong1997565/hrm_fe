...
var DateRange = { render: function () {
  ...
  computed: {
    formattedStartDate: function formattedStartDate() {
      return dateFns.format(new Date(this.startDate), this.format);
    },
    formattedEndDate: function formattedEndDate() {
      return dateFns.format(new Date(this.endDate), this.format);
    },
