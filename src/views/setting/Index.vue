...
<!--         <v-flex sm2 :class="isMini && 'd-none'">
        ...
        <v-flex sm2 :class="isMini && 'd-none'">
          <v-layout row xs12>
            ...
            <v-tooltip bottom sm6>
              <v-btn slot="activator" class="ma-0" v-if="canAccess('setting.delete')" icon @click.stop="removeConfirm(item)">
...
export default{
  ...
  computed: {
    ...mapGetters('Setting', ['settingDetail', 'filterParams']),
  ...
  methods: {
    ...
    ...mapActions('Setting', ['FetchSetting', 'deleteSetting', 'updateSetting', 'updateStatusSetting', 'clearFilter']),
    ...mapActions('Dataview', ['updateDataviewEntry', 'removeDataviewEntry']),
    ...mapActions(['showNotify', 'setMiniDrawer']),
    ...mapActions('Setting', ['createSetting']),
    addSetting () {
      this.$refs.firstInput.focus()
      this.changeTypeSetting(0)
